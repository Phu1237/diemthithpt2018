      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="khxh.php">KHXH</a>
            </li>
          </ul>
...
for ($i = 1;$i < 44; $i++) {
    ...
    $khoi = explode(' ', $khoi);
    if ($khoi[13] == 'KHXH') $mon = $KHXH; else $mon = $KHTN;
...
echo '<tr>
		<td colspan="2">Tổng kết điểm cao nhất</td>
		<td colspan="7">Toán: '.$ntoan.' với '.$toan.' điểm<br/>
						Văn: '.$nvan.' với '.$van.' điểm<br/>
						Ngoại ngữ: '.$nngoaingu.' với '.$ngoaingu.' điểm<br/>
						Lịch sử: '.$nlichsu.' với '.$lichsu.' điểm<br/>
						Địa lí: '.$ndiali.' với '.$diali.' điểm<br/>
						GDCD: '.$ngdcd.' với '.$gdcd.' điểm<br/>
						KHXH: '.$nkhxh.' với '.$khxh.' điểm<br/>
						Vật lí: '.$nvatli.' với '.$vatli.' điểm<br/>
						Hoá học: '.$nhoahoc.' với '.$hoahoc.' điểm<br/>
						Sinh học: '.$nsinhhoc.' với '.$sinhhoc.' điểm<br/>
						Khoa học tự nhiên '.$nkhtn.' với '.$khtn.' điểm
		</td>
	</tr>';
?>
  </tbody>
